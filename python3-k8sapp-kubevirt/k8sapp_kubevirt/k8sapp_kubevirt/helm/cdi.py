...
"""
This module provides functionality related to CDI Helm charts and deployment.
"""
...
class CdiHelm(base.FluxCDBaseHelm):
    """Class to encapsulate helm operations for the cdi chart"""

    CHART = app_constants.HELM_CHART_CDI
    HELM_RELEASE = app_constants.HELM_APP_CDI
    SERVICE_NAME = 'cdi'
    ...
    def get_overrides(self, namespace=None):
        ...
        overrides = {
            ...
            app_constants.HELM_NS_CDI: {
                ...
                'replicas': '1' if utils.is_single_controller(
                    dbapi.get_instance()) else '2',
                'certificateRotate': {
                    'ca': {
